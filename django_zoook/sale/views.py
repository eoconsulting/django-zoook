...
from django_zoook.sale.models import *
...
def checkout(request):
    ...
    if len(lines)>0:
        ...
        try:
            ...
            logging.warn('Need configure grid delivery in this shop or delivery grid not available')
            values['deliveries'] = []
        ...
        if sale_shop.zoook_payment_types:
            ...
            logging.warn('Need configure payment available in this shop')

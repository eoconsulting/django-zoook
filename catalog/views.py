...
def product(request,product):
    ...
    return render_to_response("catalog/product.html", {'title': title, 'metadescription': metadescription, 'product': product, 'products': products, 'base_image': base_image, 'thumb_images': thumb_images}, context_instance=RequestContext(request))
